# Freetalk - a forum system for Freenet [![Result of CI tests of branch master on Freenet's repository](https://github.com/freenet/plugin-Freetalk/actions/workflows/ci-tests.yml/badge.svg?branch=master "Result of CI tests of branch master on Freenet's repository")](https://github.com/freenet/plugin-Freetalk/actions/workflows/ci-tests.yml) [![Result of CI tests of branch master on xor-freenet's repository](https://github.com/xor-freenet/plugin-Freetalk/actions/workflows/ci-tests.yml/badge.svg?branch=master "Result of CI tests of branch master on xor-freenet's repository")](https://github.com/xor-freenet/plugin-Freetalk/actions/workflows/ci-tests.yml)
